...
function removeHandler(){
    $('.removeBtn').removeFile({removeUrl: gallerySetting.removeUrl, attribute: fileInput.attr('name'), removeItemUrl: gallerySetting.removeItemUrl})
